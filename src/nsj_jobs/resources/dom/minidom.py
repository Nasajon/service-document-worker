...
import io
import nsj_jobs.resources.dom

from nsj_jobs.resources.dom import EMPTY_NAMESPACE, EMPTY_PREFIX, XMLNS_NAMESPACE, domreg
from nsj_jobs.resources.dom.minicompat import *
from nsj_jobs.resources.dom.xmlbuilder import DOMImplementationLS, DocumentLS
...
#
_nodeTypes_with_children = (nsj_jobs.resources.dom.Node.ELEMENT_NODE,
                            nsj_jobs.resources.dom.Node.ENTITY_REFERENCE_NODE)


class Node(nsj_jobs.resources.dom.Node):
