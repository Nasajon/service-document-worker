...
from nsj_jobs.dao import Tpedido, converter_modalidade_numero
...
def montar_LayoutCalculaImpostos(t_Pedido: Tpedido, pathFile, num_notaFiscal):
    ...
    arquivo_nome = formataNumZeros(30, int(t_Pedido.pedido["num_pedido"]))
...
def montar_xml_nfse(t_Pedido: Tpedido, arquivo_xml):
    ...
    createNodeChild(
        "GRUPOEMPRESARIAL",
        t_Pedido.lstEstabelecimento[0]["grupoempresarial"],
        doc,
        base,
    )
    createNodeChild(
    ...
    createNodeChild("SERIE", t_Pedido.pedido["serie_nf"], doc, nivel_1)
    createNodeChild("SUBSERIE", t_Pedido.pedido["subserie"], doc, nivel_1)
    createNodeChild("DATAEMISSAO", t_Pedido.pedido["datasaidaentrada"], doc, nivel_1)
    createNodeChild(
        "DATASAIDAENTRADA", t_Pedido.pedido["datasaidaentrada"], doc, nivel_1
    )
    createNodeChild("DATALANCAMENTO", t_Pedido.pedido["datalancamento"], doc, nivel_1)
    createNodeChild(
    ...
    createNodeChild("LOGRADOURO", t_Pedido.endPrestacao["logradouro"], doc, nivel_2)
    createNodeChild("NUMERO", t_Pedido.endPrestacao["numero"], doc, nivel_2)
    createNodeChild("COMPLEMENTO", t_Pedido.endPrestacao["complemento"], doc, nivel_2)
    createNodeChild("BAIRRO", t_Pedido.endPrestacao["bairro"], doc, nivel_2)
    createNodeChild(
        "CODIGOMUNICIPIO", t_Pedido.endPrestacao["codigo_municipio"], doc, nivel_2
    )
    createNodeChild("MUNICIPIO", t_Pedido.endPrestacao["nome_municipio"], doc, nivel_2)
    createNodeChild("UF", t_Pedido.endPrestacao["uf"], doc, nivel_2)
    createNodeChild("CEP", t_Pedido.endPrestacao["cep"], doc, nivel_2)
    createNodeChild("PAIS", t_Pedido.endPrestacao["codigo_pais"], doc, nivel_2)
    createNodeChild("PAISNOME", t_Pedido.endPrestacao["nome_pais"], doc, nivel_2)
    createNodeChild("TELEFONE", t_Pedido.endPrestacao["telefone"], doc, nivel_2)
    createNodeChild("REFERENCIA", t_Pedido.endPrestacao["referencia"], doc, nivel_2)
    ...
    for servico in t_Pedido.lstServicos:
        ...
        createNodeChild("VALORUNITARIO", servico.get("valor_unitario"), doc, nivel_2)
        createNodeChild("VALORDESCONTO", servico.get("valordesconto"), doc, nivel_2)
    ...
    for pagamento in t_Pedido.lstFormaPagamento:
        ...
        createNodeChild(
            "TIPOFORMAPAGAMENTO", pagamento.get("tipoformapagamento"), doc, nivel_2
        )
        ...
        for parcela in pagamento.get("parcelas"):
            ...
            createNodeChild("VENCIMENTO", parcela.get("vencimento"), doc, nivel_4)
...
def montar_xml_nfe(t_Pedido: Tpedido, arquivo_xml):
    ...
    createNodeChild(
        "SOMENTE_IMPORTACAO", 1 if not t_Pedido.pedido["emitir_nota"] else 0, doc, base
    )
    createNodeChild("OBSERVACAO", t_Pedido.pedido["observacao"], doc, base)
    ...
    createNodeChild("DATALANCAMENTO", t_Pedido.pedido["datalancamento"], doc, nivel_1)
    createNodeChild("OPERACAO", t_Pedido.pedido["operacao"], doc, nivel_1)
    createNodeChild("MODELO", t_Pedido.pedido["tipodocumento"], doc, nivel_1)
    createNodeChild("TIPOOPERACAO", t_Pedido.pedido["tp_operacao"], doc, nivel_1)
    ...
    createNodeChild("VENDAPRESENCIAL", t_Pedido.pedido["vendapresencial"], doc, nivel_1)
    createNodeChild("CADASTRADOPOR", "MESTRE", doc, nivel_1)
    ...
    createNodeChild(
        "CONTRIBUINTEICMS",
        str(t_Pedido.lstCliente[0]["contribuinteicms"]),
        doc,
        nivel_1,
    )
    createNodeChild(
    ...
    if t_Pedido.endEntrega:
        ...
        createNodeChild("LOGRADOURO", t_Pedido.endEntrega["logradouro"], doc, nivel_1)
        createNodeChild("NUMERO", t_Pedido.endEntrega["numero"], doc, nivel_1)
        createNodeChild("COMPLEMENTO", t_Pedido.endEntrega["complemento"], doc, nivel_1)
        createNodeChild("CEP", t_Pedido.endEntrega["cep"], doc, nivel_1)
        createNodeChild("BAIRRO", t_Pedido.endEntrega["bairro"], doc, nivel_1)
        createNodeChild(
        ...
        createNodeChild("PAIS", t_Pedido.endEntrega["codigo_pais"], doc, nivel_1)
    ...
    for produto in t_Pedido.lstProdutos:
        ...
        createNodeChild(
            "FIGURATRIBUTARIA", produto.get("figuratributaria"), doc, nivel_2
        )
        ...
        createNodeChild(
            "VALOROUTRASDESPESAS", produto.get("valoroutrasdespesas"), doc, nivel_2
        )
