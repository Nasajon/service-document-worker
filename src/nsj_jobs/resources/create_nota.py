...
def montar_LayoutCalculaImpostos(t_Pedido: Tpedido, pathFile, num_notaFiscal):
    ...
    arquivo_nome = formataNumZeros(
        30, int(t_Pedido.lstPedido[0]['num_pedido'])) + '.xml'
    ...
    try:
        ...
        createNodeChild(
            'OPERACAO', t_Pedido.lstPedido[0]['operacao'], doc, nivel_1)
        createNodeChild(
            'MODELO', t_Pedido.lstPedido[0]['tipodocumento'], doc, nivel_1)
        createNodeChild(
            'TIPOOPERACAO', t_Pedido.lstPedido[0]['tp_operacao'], doc, nivel_1)
        createNodeChild(
            'LOCALESTOQUE', t_Pedido.lstPedido[0]['localestoque'], doc, nivel_1)
        createNodeChild('FORMAPAGAMENTO',
                        t_Pedido.lstPedido[0]['formapagamento'], doc, nivel_1)
        createNodeChild('REFERENCIAEXTERNA',
                        t_Pedido.lstPedido[0]['num_externo'], doc, nivel_1)
        ...
        createNodeChild('INFORMACOESMANUAIS',
                        t_Pedido.lstPedido[0]['observacao'], doc, nivel_1)
